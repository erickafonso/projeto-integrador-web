...
<body>
    ...
    <div class="button-container">
        <a href="graficos_fp.php">
            <button class="formas-pagamento">Seleção de datas</button>
        </a>
        <a href="graficos_evolucao_fp.php">
            <button class="formas-pagamento">Evolução</button>
        </a>
        <a href="tabelas_fp.php">
            <button class="formas-pagamento">Visualização em Tabelas</button>
        </a>
