...
// Busca os gastos por forma de pagamento com filtro de data
$usuarioId = $_SESSION['idUsuario'];
$gastosPorFormaPagamento = buscarGastosPorFormaPagamento($pdo, $usuarioId, $dataInicio, $dataFim);

// Prepara os dados para o gráfico
$formasPagamento_labels = [];
$valores = [];
$totalGeral = 0;

foreach ($gastosPorFormaPagamento as $gasto) {
    $formasPagamento_labels[] = $gasto['formapagamento'];
    $valores[] = $gasto['totalGastos'];
    $totalGeral += $gasto['totalGastos'];
}

function buscarGastosPorFormaPagamento($pdo, $usuarioId, $dataInicio, $dataFim) {
    $sql = "SELECT fp.nome AS formapagamento, SUM(c.valor) AS totalGastos
            FROM conta c
            JOIN formapagamento fp ON c.formaPagamento = fp.idFormaPagamento
...
<head>
    ...
    <title>Gastos por Forma de Pagamento</title>
...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="grafico-container">
            <h2>Distribuição de Gastos por Forma de Pagamento</h2>
            ...
            <button id="alternarGrafico" class="alternar-grafico">Alternar para Gráfico de Barras</button>
    ...
    <script>
        ...
        const formasPagamentoLabels = <?= json_encode($formasPagamento_labels) ?>;
        ...
        // Configuração inicial do gráfico (Pizza)
        ...
        let chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Gastos por Forma de Pagamento',
                    data: valores,
        ...
        // Função para alternar entre gráfico de pizza e barras
        document.getElementById('alternarGrafico').addEventListener('click', function() {
            chart.destroy();
            
            tipoGraficoAtual = tipoGraficoAtual === 'pie' ? 'bar' : 'pie';
            
            this.textContent = tipoGraficoAtual === 'pie' 
            ...
            chart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Gastos por Forma de Pagamento',
                        data: valores,
                        backgroundColor: tipoGraficoAtual === 'pie' ? cores : '#4CAF50',
                        borderWidth: 1
                    }]
                },
                options: {
