...
<script>
    var categoriasLabels = <?php echo json_encode($categorias_labels); ?>; // Passa os nomes das categorias do PHP para o JS
    var valores = <?php echo json_encode($valores); ?>; // Passa os totais das categorias do PHP para o JS

    var ctx = document.getElementById('graficoPizza').getContext('2d');
    var graficoPizza = new Chart(ctx, {
        type: 'pie',
        data: {
            labels: categoriasLabels, // Agora os labels são as categorias
            datasets: [{
                label: 'Gastos por Categoria',
                data: valores, // Agora os dados são os totais de cada categoria
                backgroundColor: ['#FF5733', '#33FF57', '#3357FF', '#FF8333', '#33C4FF', '#FF3399'], // Cores para cada categoria
            }]
        },
        options: {
            responsive: true,
